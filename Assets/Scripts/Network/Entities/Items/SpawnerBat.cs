...
public class SpawnerBat : RisingPickup, RisingInteractable
{
    [Header("Setup")]
    ...
    public void Interact()
    {
        ...
        pos.z += 1.5f;
        GameObject ball = PhotonNetwork.Instantiate("PF_SpawnedBall", pos, transform.rotation);
        float xDir = Random.Range(-2f, 2f);
        ball.GetComponent<Rigidbody>().AddRelativeForce(new Vector3(xDir, 1.0f, 3.0f) * hitPower.x, ForceMode.Impulse);
    }
